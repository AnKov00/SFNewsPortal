# Generated by Django 5.2.2 on 2025-07-13 18:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('nw', 'Новость'), ('st', 'Статья')], default='st', max_length=2)),
        ...
        migrations.AddField(
            model_name='category',
            name='subscribers',
            field=models.ManyToManyField(through='posts.UsersCategory', to=settings.AUTH_USER_MODEL),
        ),
    ]

...
from .views import PostList, PostSearch, OnePost, NewsCreate, ArticCreate, NewsUpdate, NewsDelete
...
urlpatterns = [
    ...
    path('articles/create/', ArticCreate.as_view(), name='articles_create'),
